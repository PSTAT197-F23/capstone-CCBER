...
-   <u>Perspective Correction</u>: JupyterNotebook tool to correct warped field bee wing images

-   <u>Reports</u>: contains two JupyterNotebook scripts that explore Linear Discriminant Analysis (LDA) and Spectral Embedding with line annotations and a written report on the subjects
...
-   <u>VGG16</u>: contains 2 folders and 1 JupyterNotebook script containing the code for the neural network VVG-16
...
-   <u>Wing Length Calculation</u>: contains two JupyterNotebook scripts--one that calculates wing length in mm from ARuCO markers, and one that calculates wing length in mm from the ruler
