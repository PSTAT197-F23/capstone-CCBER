...
## Cropped Image includes ARuCO markers
...
def crop_image_to_square(image, marker_corners):
    ...
    side_length = int(max(np.linalg.norm(corner1 - corner2), np.linalg.norm(corner2 - corner3),
    ...
    # Crop the image to the square region, including markers
